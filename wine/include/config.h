...
#define HAVE_AUDIOTOOLBOX_AUDIOCONVERTER_H 1

/* Define to 1 if you have the <AudioUnit/AudioComponent.h> header file. */
#define HAVE_AUDIOUNIT_AUDIOCOMPONENT_H 1
...
#define HAVE_LDAP_PARSE_SORT_CONTROL 1
...
#define HAVE_LDAP_PARSE_VLV_CONTROL 1
...
#define PACKAGE_STRING "Wine 2.16"
...
#define SONAME_LIBDBUS_1 "libdbus-1.3.dylib"
